...
const ObservationForm = (params) => {
    ...
    const SubmitForm = (e) => {
        ...
        e.preventDefault();
        let datos = {
            "leader_observations": state.leader_observations
        }
        updateAdvance({
                ...
                loader ?
                    ...
                    !error ?
                        <div className="row mt-3">
                            <h2>Observaciones proyecto</h2>
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item">
                                        <Link to={"/advances/"+state.project_id}>Lista de Avances </Link></li>
                                    <li className="breadcrumb-item active" aria-current="page">Editar Observacion</li>
                                </ol>
                            </nav>
                            <hr/>
                                ...
                                >
                                    ...
                                    <div className="form-outline mb-2">
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) => setState({ ...state, leader_observations: e.target.value })}
                                            required
                                        >
                                        </textarea>
                                    </div>
